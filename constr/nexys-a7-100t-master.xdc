...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { game_over }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { place_bomb }]; #IO_L9P_T1_DQS_14 Sch=btnc
...
##Pmod Headers
##Pmod Header JA
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { uart_rx }]; #IO_L20N_T3_A19_15 Sch=ja[1]
...
##VGA Connector
set_property -dict { PACKAGE_PIN A3    IOSTANDARD LVCMOS33 } [get_ports { o_pix_r[0] }]; #IO_L8N_T1_AD14N_35 Sch=o_pix_r[0]
set_property -dict { PACKAGE_PIN B4    IOSTANDARD LVCMOS33 } [get_ports { o_pix_r[1] }]; #IO_L7N_T1_AD6N_35 Sch=o_pix_r[1]
set_property -dict { PACKAGE_PIN C5    IOSTANDARD LVCMOS33 } [get_ports { o_pix_r[2] }]; #IO_L1N_T0_AD4N_35 Sch=o_pix_r[2]
set_property -dict { PACKAGE_PIN A4    IOSTANDARD LVCMOS33 } [get_ports { o_pix_r[3] }]; #IO_L8P_T1_AD14P_35 Sch=o_pix_r[3]
set_property -dict { PACKAGE_PIN C6    IOSTANDARD LVCMOS33 } [get_ports { o_pix_g[0] }]; #IO_L1P_T0_AD4P_35 Sch=o_pix_g[0]
set_property -dict { PACKAGE_PIN A5    IOSTANDARD LVCMOS33 } [get_ports { o_pix_g[1] }]; #IO_L3N_T0_DQS_AD5N_35 Sch=o_pix_g[1]
set_property -dict { PACKAGE_PIN B6    IOSTANDARD LVCMOS33 } [get_ports { o_pix_g[2] }]; #IO_L2N_T0_AD12N_35 Sch=o_pix_g[2]
set_property -dict { PACKAGE_PIN A6    IOSTANDARD LVCMOS33 } [get_ports { o_pix_g[3] }]; #IO_L3P_T0_DQS_AD5P_35 Sch=o_pix_g[3]
set_property -dict { PACKAGE_PIN B7    IOSTANDARD LVCMOS33 } [get_ports { o_pix_b[0] }]; #IO_L2P_T0_AD12P_35 Sch=o_pix_b[0]
set_property -dict { PACKAGE_PIN C7    IOSTANDARD LVCMOS33 } [get_ports { o_pix_b[1] }]; #IO_L4N_T0_35 Sch=o_pix_b[1]
set_property -dict { PACKAGE_PIN D7    IOSTANDARD LVCMOS33 } [get_ports { o_pix_b[2] }]; #IO_L6N_T0_VREF_35 Sch=o_pix_b[2]
set_property -dict { PACKAGE_PIN D8    IOSTANDARD LVCMOS33 } [get_ports { o_pix_b[3] }]; #IO_L4P_T0_35 Sch=o_pix_b[3]
